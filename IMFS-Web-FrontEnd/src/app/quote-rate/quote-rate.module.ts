...
import { QuoteRateRoutingModule } from './quote-rate-routing.module';
...
@NgModule({
    imports: [CommonModule, DialogModule, ConfirmDialogModule, InputTextModule, InputTextareaModule,
        ...
        FileUploadModule, QuoteRateRoutingModule],
    declarations: [QuoteRateComponent, QuoteRateDetailsModalComponent, QuoteRateUploadModalComponent],
    exports: [],
})
export class QuoteRateModule { }
