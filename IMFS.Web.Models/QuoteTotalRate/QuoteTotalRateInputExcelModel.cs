...
{
    public class QuoteTotalRateInputExcelModel
    {
    ...
    public class TotalRateInputExcelModelMap : ClassMap<QuoteTotalRateInputExcelModel>
    {
        public TotalRateInputExcelModelMap()
        {
